...
function Footer() {
  return (
    <footer className="bg-[#001931] text-white py-10 px-4 sm:px-6">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
        ...
        <div className="flex flex-col space-y-2 text-sm sm:text-base md:pl-10">
        ...
        <div>
          ...
          <div className="flex justify-center md:justify-start space-x-4 mb-4">
            <a
              href="#"
              className="bg-[#0A3D62] p-2 rounded-full hover:bg-[#FF8811] transition-all duration-200"
            >
              <FaFacebookF />
            </a>
            <a
      ...
      <div className="border-t border-gray-700 mt-8 pt-4 text-center text-gray-400 text-xs sm:text-sm">
        © {new Date().getFullYear()} AppVerseRZ. All rights reserved by Razaan
        Reza.
      </div>
    </footer>
  )
