      ...
      <div className="cards pt-2 transition-transform duration-300 hover:-translate-y-2 hover:shadow-md">
        ...
        >
          ...
          <div className="card-body">
            <h2 className="card-title text-[13px] sm:text-[15px]">{title}</h2>
          </div>
          <div className="flex justify-between px-4">
            <div className="flex items-center gap-2 bg-[#F1F5E8] p-2">
              <img className="w-4 h-4" src={downloads_icon} alt="downloads_icon" />
              <p className="text-xs font-semibold text-[#00D390]">{downloads}</p>
            </div>
            <div className="flex items-center gap-2 bg-[#FFF0E1] p-2">
              <img className="w-4 h-4" src={rating_icon} alt="downloads_icon" />
              <p className="text-xs font-semibold text-[#FF8811]">{ratingAvg}</p>
            </div>
          </div>
        </Link>
      </div>
